...
def contact_par_email(email: str) -> Optional[dict]:
...
def admin_hash(username: str) -> Optional[dict]:
...
def exporter_csv(chemin: str, contacts: Optional[List[Dict]] = None) -> int:
    """
